...
export default function AboutGurukulam() {
    ...
    return (
        <div className="relative min-h-screen bg-gradient-to-br from-[#f7f6ef] via-white to-[#eef3ec] px-4 py-12 overflow-hidden">
            ...
            <div className="max-w-6xl mx-auto relative z-10">
                ...
                <motion.div initial={{ opacity: 0, y: -40 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-12">
                    <h1 className="text-5xl font-extrabold bg-gradient-to-r from-[#156445] to-[#CFAF5C] bg-clip-text text-transparent">
                        About Gurukulam
                    </h1>
                </motion.div>
                ...
                <section className="py-10 px-4 md:px-8 lg:px-16">
                    <div className="relative max-w-5xl mx-auto group">
                        ...
                        {/* Glow Border */}
                        <div className="absolute -inset-[2px] rounded-3xl bg-gradient-to-r from-[#156445] via-[#CFAF5C] to-[#296236] opacity-20 blur-xl group-hover:opacity-40 transition duration-500"></div>

                        {/* Card */}
                        <div className="relative bg-white/80 backdrop-blur-xl border border-[#e6e2c8] rounded-3xl p-8 md:p-12 shadow-xl hover:shadow-2xl transition-all duration-500">

                            <h2 className="text-3xl md:text-4xl font-bold mb-6 bg-gradient-to-r from-[#156445] to-[#CFAF5C] bg-clip-text text-transparent">
                                About Us
                            </h2>
                ...
                <motion.div className="grid md:grid-cols-4 gap-6 mb-14">
                    {[
                        ...
                        <motion.div key={i} whileHover={{ scale: 1.08 }} className="relative group">

                            <div className="absolute -inset-[2px] rounded-2xl overflow-hidden">
                                <div className="w-full h-full animate-spin-slow bg-gradient-to-r from-[#156445] via-[#CFAF5C] to-[#296236] opacity-30 blur-md"></div>
                            </div>

                            <div className="relative bg-white/80 backdrop-blur-lg rounded-2xl p-6 text-center shadow-xl border border-[#e6e2c8]">
                                <h3 className="text-3xl font-bold bg-gradient-to-r from-[#156445] to-[#E4CC6F] bg-clip-text text-transparent">
                                    {item[0]}
                                </h3>
                ...
                <section className="py-20 px-4 md:px-8 lg:px-16">
                    <div className="max-w-6xl mx-auto">
                        ...
                        <div className="text-center mb-14">
                            <h2 className="text-4xl md:text-5xl font-extrabold bg-gradient-to-r from-[#156445] to-[#CFAF5C] bg-clip-text text-transparent">
                                Why Choose Gurukulam?
                            </h2>

                            <div className="mt-6 max-w-3xl mx-auto space-y-4">
                               <p className="text-gray-700 text-lg leading-relaxed"> At <span className="font-semibold text-green-600">Gurukulam</span>, we believe education is not just about academics — it’s about shaping <span className="font-medium text-gray-900">confident, responsible, and future-ready individuals</span>. </p> <p className="text-gray-600 text-lg leading-relaxed"> Our approach blends <span className="font-medium text-green-500"> traditional values</span> with <span className="font-medium text-green-500"> modern learning methods</span>, ensuring every student experiences holistic growth in a nurturing and inspiring environment. </p> <p className="text-gray-600 text-lg leading-relaxed"> We focus on building strong foundations, encouraging curiosity, and empowering students with the skills they need to thrive in an ever-evolving world. </p>
                            </div>
                        </div>
                        ...
                        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                            {[
                                ...
                                >
                                    <div className="absolute -inset-[2px] rounded-2xl bg-gradient-to-r from-[#156445] via-[#CFAF5C] to-[#296236] opacity-20 blur-lg group-hover:opacity-40 transition duration-500"></div>

                                    <div className="relative bg-white/80 backdrop-blur-xl border border-[#e6e2c8] rounded-2xl p-6 shadow-lg hover:shadow-2xl transition duration-500 h-full">
